...
function Step2Interview({ interviewData, onFinish, preferredGender }) {
  ...
  useEffect(() => {
    const loadVoices = () => {
      ...
      if (preferredGender === "female") {
        ...
        // female not found, try male as fallback
        ...
        if (maleFallback) {
          setSelectedVoice(maleFallback);
          setVoiceGender("male");
          alert("Female voice not available on your device. Switching to male voice.");
          return;
        }
      } else {
        ...
        // male not found, try female as fallback
        ...
        if (femaleFallback) {
          setSelectedVoice(femaleFallback);
          setVoiceGender("female");
          alert("Male voice not available on your device. Switching to female voice.");
          return;
        }
      }

      // Nothing found at all
      alert("No suitable voice found on your device. Please check your system voices.");
      setSelectedVoice(voices[0]);
      setVoiceGender("female");
    };
