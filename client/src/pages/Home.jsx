          ...
          <div className='text-center mb-28'>
            ...
            <div className='flex flex-wrap justify-center gap-4 mt-10'>
              ...
              <motion.button
                ...
                whileHover={{ opacity: 0.9, scale: 1.03 }}
                whileTap={{ opacity: 1, scale: 0.98 }}
                className='bg-green-600 text-white px-10 py-3 rounded-full hover:opacity-90 transition shadow-md'>
                Job Finder
              </motion.button>
              ...
              <motion.button
                ...
                whileHover={{ opacity: 0.9, scale: 1.03 }}
                whileTap={{ opacity: 1, scale: 0.98 }}
                className='border border-green-500 text-green-600 px-10 py-3 rounded-full hover:bg-green-50 transition'>
                Cover Letter
              </motion.button>
            </div>
          </div>
